% make_pages
% clear;
function display_retrieved_bboxes(clsNdx,num_match)
...
fn = ['/home/yjlee/web/weakVideo/php/' cls '_retrieved_bboxes_num_match=' num2str(num_match) '_mirror.html'];        
disp(fn);
